...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("hardchain"),
	impl_name: create_runtime_str!("hardchain"),
	authoring_version: 3,
	spec_version: 4,
	impl_version: 4,
...
/// Used for the module template in `./template.rs`
impl hardchain::Trait for Runtime {
	type Event = Event;
}
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		Sudo: sudo,
		// Used for the module template in `./template.rs`
		HardchainModule: hardchain::{Module, Call, Storage, Event<T>},
	}
);
